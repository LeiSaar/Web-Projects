...
const ContactUs = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "017d5476-e746-48ca-831e-4786241e7e96");
        ...
        pt-30 text-gray-700 dark:text-white'>
            ...
            <motion.form
                ...
                <motion.div className='sm:col-span-2'>
                    ...
                    <textarea name="message" rows={8} placeholder='Enter your message' required className='border border-gray-300 dark:border-gray-600 w-full p-3 text-sm outline-none rounded-lg'></textarea>
                </motion.div>

                <motion.button type="submit" className='bg-primary w-max flex gap-2 text-white text-sm px-10 py-3 rounded-full
