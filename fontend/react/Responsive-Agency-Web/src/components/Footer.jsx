...
const Footer = ({ theme }) => {
    ...
    sm:px-10 lg:px-24 xl:px-40'>
            ...
            <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
                ...
                <div className="text-gray-600 dark:text-gray-400">
                    ...
                    <div className='flex gap-2 text-sm'>
                        <input type="email" name="email" placeholder='Enter your email' className='border border-gray-300 dark:border-gray-500 
                        w-full p-3 text-sm outline-none rounded dark:text-gray-300'/>
            ...
            <div className='pb-6 text-sm text-gray-500 flex justify-center sm:justify-between gap-4 flex-warp '>
                <p>Copyright &#169; 2026 SunnyBeach - All Right Reserved.</p>
